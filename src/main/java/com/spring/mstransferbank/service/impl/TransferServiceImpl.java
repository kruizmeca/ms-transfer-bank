...
public class TransferServiceImpl implements TransferService {
    ...
    WebClient webClientCurrent = WebClient.create("http://servicio-zuul-server:9090/ms-current-account/currentAccount");

    WebClient webClientFixed = WebClient.create("http://servicio-zuul-server:9090/ms-fixed-term/fixedTerm");

    WebClient webClientSaving = WebClient.create("http://servicio-zuul-server:9090/ms-saving-account/savingAccount");
